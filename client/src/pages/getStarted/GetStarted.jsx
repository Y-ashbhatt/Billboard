    ...
    <div className="flex flex-col lg:flex-row min-h-screen">
      ...
      <div className="lg:w-1/2 w-full flex justify-center items-center p-6">
        <div className="max-w-[30rem]">
          {/* Heading */}
          <h1 className="text-5xl leading-snug mb-8 text-gray-900">
            Welcome to the
            <br /> BillBoard AI &
          ...
          <button
            ...
            className="w-full bg-white border mb-8 border-gray-600 text-[#420d8b] hover:bg-[#420d8b] hover:text-white py-2 rounded-full text-base focus:outline-none focus:ring-2 focus:ring-offset-2 hover:shadow-md transition duration-300"
          >
            Log In
          </button>
          {/* Call to Action */}
