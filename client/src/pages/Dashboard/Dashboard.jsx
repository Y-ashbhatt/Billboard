        ...
        <div className="bg-gray-100 min-h-screen flex">
            ...
            <aside className="w-50">
                <div className="p-4 mt-6 flex items-center justify-center">
                    <div className="w-20 h-20 rounded-full text-white flex items-center justify-center font-bold">
                        <img className="w-20 h-20 rounded-full" src={finalImage} alt="Profile" />
                    </div>
                </div>
                <nav className="mt-6">
            ...
            <main className="flex-1 p-6">
                ...
                <header className="flex justify-between items-center mb-6">
                    ...
                    {/* Create Task Button */}
                    <button onClick={() => navigate("/")} className="bg-purple-600 text-white px-6 py-2 rounded-full font-semibold shadow-lg hover:bg-purple-800">
                        Create Task
                    </button>
                </header>

                <div
                    className="flex mt-2 mb-6"
                >
                    <h1
                        className="text-3xl"
                    >
                ...
                <div className="grid grid-cols-3 gap-6">
                    ...
                    <div className="bg-white rounded-lg shadow-lg p-4">
                        ...
                        <button onClick={() => navigate("/upload-billboard")} className="w-full mt-4 bg-white border-solid border-2 border-purple-600 text-purple-600 px-6 py-2 rounded-full font-semibold shadow-lg hover:bg-purple-600 hover:text-white">
                            Create Task
                        </button>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow-lg p-4">
                        ...
                        <ul className="space-y-4 p-0">
                            <li
                                    className="flex items-center bg-gray-100 rounded-2xl p-4 border-2 border-gray-200"
                                >
