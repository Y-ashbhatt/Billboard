    ...
    return (
        <div className="" >
            <div className="tool-content p-4 bg-white rounded-lg shadow-lg">
                ...
                <span className="mb-2">
                    <KeyboardDoubleArrowLeftIcon style={{ color: 'black', margin: '0px 0px 6px 150px' }} />
                </span>
                ...
                <div id="uploaded-images" className={`${activeTab === 'images' ? '' : 'hidden'} mt-4`}>
                ...
                <div id="uploaded-videos" className={`${activeTab === 'videos' ? '' : 'hidden'} mt-4`}>
