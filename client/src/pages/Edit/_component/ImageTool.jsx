            ...
            <div className="p-4 bg-white rounded-lg shadow-lg">
                ...
                <div className="mt-4">
                    <div className="flex w-full justify-between font-semibold text-sm">
                        <div
                            className={`px-4 py-2 cursor-pointer  border-b-4 w-1/2 text-center border-gray-300 ${activeTab === 'pixabay-images' ? ' border-[#a134ff] ' : ' border-gray-300'}`}
                    ...
                    <div className={`mt-4 ${activeTab === 'pixabay-images' ? '' : 'hidden'}`}>
                        <div className="space-y-4">
                            <div className="flex space-x-2">
                                ...
                                <button
                                    ...
                                    onClick={() => console.log(`Searching Pixabay for ${pixabaySearch}`)}
                                >
                                    <SearchIcon />
                                </button>
                            </div>
                            ...
                            <div className="mt-4">
                                <div>Photos provided by <a href="https://pixabay.com/" target="_blank" className="text-blue-500">Pixabay</a>.</div>
                            </div>
                        </div>
                    </div>

                    <div className={`mt-4 ${activeTab === 'pexels-images' ? '' : 'hidden'}`}>
                        <div className="space-y-4">
                            <div className="flex space-x-2">
                                <input
                                ...
                                <button
                                    ...
                                    onClick={() => console.log(`Searching Pexels for ${pexelsSearch}`)}
                                >
                            ...
                            <div className="space-y-2">
                                <select className="custom-select w-full p-2 border rounded-md" disabled>
                                    <option value="">All Orientations</option>
                ...
                >
                  More Settings <span className="material-icons">expand_more</span>
                            ...
                            <div className="mt-4">
                                <div>Photos provided by <a href="https://pexels.com/" target="_blank" className="text-blue-500">Pexels</a>.</div>
                            </div>
                        </div>
                    </div>
                </div>
